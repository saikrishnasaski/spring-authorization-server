...
import static com.csk.security.services.config.CustomClientMetadataConfig.configureCustomClientMetadataConverters;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http)
        ...
        http.getConfigurer(OAuth2AuthorizationServerConfigurer.class)
                .oidc(oidc -> oidc.clientRegistrationEndpoint(clientRegisteredEndpoint ->
                        clientRegisteredEndpoint.authenticationProviders(configureCustomClientMetadataConverters())));	// Enable OpenID Connect 1.0
        http
